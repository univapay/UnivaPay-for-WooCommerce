...
function univapay_init_gateway_class() {
	 ...
	 *
	 * @param array $gateways all available WC payment gateways.
	 * @return array $gateways all WC payment gateways + univapay.
	 */
	...
	function custom_metabox_content( $post ) {
		...
		echo '<h4>ステータス: ' . esc_html( $charge->status->getValue() ) . '</h4>';
