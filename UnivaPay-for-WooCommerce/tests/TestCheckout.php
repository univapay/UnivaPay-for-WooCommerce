...
class TestCheckout extends BasePluginTest {
	...
	/**
	 * Test that the custom payment gateway is displayed on the classic checkout page.
	 */
	...
	/**
	 * Test that the custom payment gateway is displayed on the block checkout page.
	 */
